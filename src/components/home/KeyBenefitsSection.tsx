      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center p-6 group">
            <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mb-4 animate-float">
              <Clock className="h-6 w-6 text-secgpt-blue transition-transform duration-300 group-hover:scale-125" />
            </div>
          ...
          <div className="flex flex-col items-center text-center p-6 group">
            <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mb-4 animate-float [animation-delay:0.2s]">
              <Shield className="h-6 w-6 text-secgpt-blue transition-transform duration-300 group-hover:scale-125" />
            </div>
          ...
          <div className="flex flex-col items-center text-center p-6 group">
            <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mb-4 animate-float [animation-delay:0.4s]">
              <Award className="h-6 w-6 text-secgpt-blue transition-transform duration-300 group-hover:scale-125" />
            </div>
