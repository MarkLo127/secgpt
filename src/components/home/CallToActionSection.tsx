...
const CallToActionSection = () => {
  ...
  return <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-secgpt-accent/10 rounded-full blur-3xl animate-pulse" style={{
      animationDelay: '1s'
    }}></div>
        ...
        <div className="glass-card p-8 md:p-12 max-w-4xl mx-auto border border-secgpt-blue/20 hover:border-secgpt-blue/30 transition-all duration-300 hover:shadow-lg">
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <SparklesIcon className="h-6 w-6 text-secgpt-accent absolute -top-2 -right-2 animate-pulse" style={{
              animationDelay: '0.5s'
            }} />
            </div>
          </div>
          
          <h2 className="text-3xl md:text-4xl font-bold tech-text-gradient mb-6 animate-fade-in text-center">
            {t("home.title")}
          </h2>
          
          <p style={{
          animationDelay: '0.2s'
        }} className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto animate-fade-in text-center">
            {t("home.description")}
          </p>
          ...
          animationDelay: '0.4s'
            ...
            <Link to="/analysis" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-secgpt-blue to-secgpt-accent hover:from-secgpt-accent hover:to-secgpt-blue transition-all duration-300 group text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12 text-sm">
            <div className="flex items-center space-x-2 p-3 rounded-lg bg-secgpt-blue/10 animate-fade-in" style={{
            animationDelay: '0.6s'
          }}>
              ...
              <span className="text-secgpt-blue font-medium text-center">{t("home.how_it_works.step1.title")}</span>
            </div>
            <div className="flex items-center space-x-2 p-3 rounded-lg bg-secgpt-blue/10 animate-fade-in" style={{
            animationDelay: '0.8s'
          }}>
              ...
              <span className="text-secgpt-blue font-medium text-center">{t("home.how_it_works.step2.title")}</span>
            </div>
            <div className="flex items-center space-x-2 p-3 rounded-lg bg-secgpt-blue/10 animate-fade-in" style={{
            animationDelay: '1s'
          }}>
              ...
              <span className="text-secgpt-blue font-medium text-center">{t("home.how_it_works.step3.title")}</span>
            </div>
          </div>
        </div>
      </div>
